...
const validadtionComposite = new ValidationComposite();

validadtionComposite.add(validateString, validateEmail, validadeNumber);

console.log(validadtionComposite.validate('12345@'));
